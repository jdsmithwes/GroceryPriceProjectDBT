...
CREATE TABLE IF NOT EXISTS GROCERYDBTPROJECT.GROCERY_RAW_KROGER.KROGER_LOCATIONS (
  LOCATIONID STRING,
  REGION STRING,
...
ALTER TABLE GROCERYDBTPROJECT.GROCERY_RAW_KROGER.KROGER_LOCATIONS
...
-- files.
CREATE OR REPLACE PIPE GROCERYDBTPROJECT.AWS_RESOURCES_KROGER.KROGER_LOCATIONS_PIPE
  AUTO_INGEST = TRUE
AS
  COPY INTO GROCERYDBTPROJECT.GROCERY_RAW_KROGER.KROGER_LOCATIONS
