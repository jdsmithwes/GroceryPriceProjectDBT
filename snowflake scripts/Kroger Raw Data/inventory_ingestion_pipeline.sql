...
CREATE TABLE IF NOT EXISTS GROCERYDBTPROJECT.GROCERY_RAW_KROGER.KROGER_INVENTORY (
  PRODUCTID STRING,
  LOCATIONID STRING,
...
ALTER TABLE GROCERYDBTPROJECT.GROCERY_RAW_KROGER.KROGER_INVENTORY
...
-- files.
CREATE OR REPLACE PIPE GROCERYDBTPROJECT.AWS_RESOURCES_KROGER.KROGER_INVENTORY_PIPE
  AUTO_INGEST = TRUE
AS
  COPY INTO GROCERYDBTPROJECT.GROCERY_RAW_KROGER.KROGER_INVENTORY
